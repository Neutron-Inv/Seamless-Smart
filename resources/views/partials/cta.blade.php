...
<section id="contact">
    <div class="bg-cover bg-center rounded-2xl w-full py-14 space-y-10 text-center" data-aos="fade-up" data-aos-duration="800" data-aos-delay="400" style="background-image: url('{{ asset('/storage/images/ctabg.png') }}');">
        ...
        <a href="javascript:void(0);" @click="open = true" class="bg-[#afdf34] text-white text-sm font-semibold px-6 py-3 rounded-lg hover:bg-green-700 transition-all w-auto sm:w-auto inline-block">
            Contact Us
        </a>
