<section id="cadastral-details" class="w-full py-16 px-6 md:px-16 bg-gray-100">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-10 items-center max-w-6xl mx-auto">
        ...
        <!-- Image Section -->
        <div class="relative">
            <img src="{{ asset('/storage/images/cadastral-1.webp') }}" class="rounded-lg shadow-lg w-full">
            
            <!-- Optional Second Image -->
            <img src="{{ asset('/storage/images/cadastral-2.webp') }}" 
                 class="absolute right-0 bottom-0 w-1/2 rounded-lg shadow-lg hidden md:block border-4 border-white">
        </div>
